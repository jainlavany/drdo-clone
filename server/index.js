...
async function seedIfEmpty() {
  ...
  if ((await Product.countDocuments()) === 0) {
    ...
    await Product.insertMany([
      ...
      { title: 'ACADA', imageUrl: 'https://drdo.gov.in/drdo/sites/default/files/styles/card_image/public/products/automatic-chemical-agent-detector-alarm-acada', link: 'https://drdo.gov.in/drdo/en/offerings/products/automatic-chemical-agent-detector-alarm-acada' },
